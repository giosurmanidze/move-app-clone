    ...
    <div className={`burger ${cName}`} ref={ref}>
      ...
      <div className="burger__pages--icons">
        ...
        <div className="burger__pages--icons--box box2">
          ...
          <span onClick={() => setShow({...show,dropdown1:!show.dropdown1})}>
            ფილმები
            <MdOutlineArrowDropDown className="burger__icon down__arrow" />
          </span>
        </div>
          <div className={`category ${show.dropdown1 ? "show__dropdown": "hide__dropdown"}`}>
            <p>ყველა</p>
            <p>ქართულად</p>
            <p>ანიმაცია</p>
            <p>დოკუმენტური</p>
        ...
        <div className="burger__pages--icons--box">
          ...
          <span onClick={() => setShow({...show,dropdown2:!show.dropdown2})}>
            სერიალები
            <MdOutlineArrowDropDown className="burger__icon down__arrow" />
          </span>
        </div>
          <div className={`category ${show.dropdown2? "show__dropdown": "hide__dropdown"}`}>
            <p>ყველა</p>
            <p>ქართულად</p>
            <p>თურქული</p>
          </div>
